---
name: berker-job-search-v2
description: |
  Berker Berberoğlu için iş ilanı arama sistemi — Dashboard V2.
  V2 özellikleri: ⭐ Favoriler, ✅ Başvurulanlar, ❌ Geçilenler ayrı sekmelerde,
  işaretlenen ilanlar ana listeden çıkar, 🎯 Script sekmesi, 🕐 Son Eklenen sıralama butonu.
  MUTLAKA kullan: "ilanları güncelle", "yeni ilanlar", "dashboard güncelle", "iş ilanı ara" ifadelerinde.
---

# Berker İş İlanı Arama Sistemi — V2

## Dashboard
- Dosya: `/Users/berkerberberoglu/Desktop/claudelinkedin/dashboard-v2.html`
...
- Push: `bash /Users/berkerberberoglu/Desktop/claudelinkedin/push_dashboard.sh`
  (push_dashboard.sh'de FILE değişkenini dashboard-v2.html olarak güncelle)
...
2. Yeni ilanları filtrele ve ekle
...
7. push_dashboard.sh'deki FILE=dashboard-v2.html olduğunu kontrol et, sonra çalıştır
8. Özet rapor ver
